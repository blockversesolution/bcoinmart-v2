                    ...
                    <div class="signup-content">
                        ...
                        <form action="{{route('register.otp.check')}}" class="signup-form mb-30" method="POST">
                            ...
                            <div class="form-input mb-40">
                                ...
                                <input type="text" name="code" class="@error('code') is-invalid @enderror" id="email-input" placeholder="Enter your code">
                                @error('code')
                        ...
                        <p class="sign-or-login"><a href="{{route('register.otp.resend')}}">Didn't receive the code?</a></p>
                    </div>
                </div>
            </div>
        </div>
